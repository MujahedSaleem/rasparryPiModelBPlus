...
@Component({
    selector: 'app-DL2108TAL-SW',
    templateUrl: './DL2108TAL-SW.component.html',
    styleUrls: ['./DL2108TAL-SW.component.scss']
})
export class DL2108TALComponent implements OnInit, OnDestroy {
